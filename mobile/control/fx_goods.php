...
class fx_goodsControl extends mobileHomeControl{
    ...
    public function goods_detailOp() {
        ...
        if(!empty($goods_info)){
//             $goods_detail['goods_image'] = thumb($goods_info, '60');
            $goods_detail['goods_image'] = cthumb($goods_info['goods_image'],1280);
            $goods_detail['goods_name'] = $goods_info['goods_name'];
            $goods_detail['goods_jingle'] = $goods_info['goods_jingle'];
            $goods_detail['goods_price'] = $goods_info['goods_price'];
            $goods_detail['goods_storage'] = $goods_info['goods_storage'];
            $model_agent = Model('fx_agent');
            
            $agent_info = $model_agent->getOneAgent($goods_info['agent_id']);
            $goods_detail['agent_name'] = $agent_info ['agent_name'];
            $goods_detail['agent_id'] = $agent_info ['agent_id'];
        }
