...
class fx_member_paymentControl extends mobileMemberControl {
    ...
    private function _get_real_order_info($pay_sn,$rcb_pd_pay = array()) {
        ...
        $param['order_sn'] = $pay_sn;
        $order_info = $fx_order->infoOrders($param);
        $result['data']['pay_sn'] = $pay_sn;
        $result['data']['api_pay_amount'] = $order_info['order_amount'];
        $result['data']['order_type'] = 'r';
