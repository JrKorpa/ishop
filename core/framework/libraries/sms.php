...
class Sms {
    ...
    public function send($mobile,$content) {
       ...
       switch ($hao_sms_type) {
           ...
           case 3: {
               return $this->send_jike($mobile, $content);
           }
       }
    }
...
/*
	...
	*/
    ...
    private function send_jike($mobile, $content) {
        define('PLUGIN_ROOT', BASE_DATA_PATH . DS .'api/smsapi');
        $filePath=PLUGIN_ROOT . DS . 'JikeCrm.php';
        require_once($filePath);
        $client = new jikeCrm();
        return $client->sendImmediately([$mobile], $content);
    }
    /**
     * 亿美短信发送接口
     * @param unknown $mobile 手机号
