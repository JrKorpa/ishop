  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base nc-row">
        <li><a href="index.php?act=agent&op=index">代理商列表</a></li>
...
$(function(){
    $("#flexigrid").flexigrid({
        url: 'index.php?act=agent&op=get_xml',
        colModel : [
            {display: '操作', name : 'w_no', width : 140, sortable : true, align: 'left'},
...
function tongguo(id){
	$.ajax({
        type:"POST",
        url:'index.php?act=agent&op=tongguo',  
        async:false,  
        data:{
            'agent_id': id,
            },
...
function butongguo(id){
	$.ajax({
        type:"POST",
        url:'index.php?act=agent&op=butongguo',  
        async:false,  
        data:{
            'agent_id': id,
            },
