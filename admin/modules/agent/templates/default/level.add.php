  ...
  <form id="level_form" method="post">
    ...
    <div class="ncap-form-default">
      <dl class="row">
        ...
        <dd class="opt">
          <input type="text" value="" id="level_name" name="level_name" class="input-txt">
          <span class="err"></span>
        </dd>
      </dl>
      <dl class="row">
        <dt class="tit">
          <label for="join_fee"><em>*</em><?php echo 加盟费用?></label>
        </dt>
        <dd class="opt">
          <input type="text" value="" id="join_fee" name="join_fee" class="input-txt">
          <span class="err"></span>
