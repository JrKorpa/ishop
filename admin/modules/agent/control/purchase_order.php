...
class purchase_orderControl extends SystemControl{
    ...
    public function get_xmlOp() {
        /**
         * @var $model_commission fx_purchase_ordersModel
         */
...
//             }
    ...
    public function peisongOp(){
        ...
        $fx_goods_info = $model_fx_goods->infoGoods($where, $field = 'fx_goods_id,goods_storage,items_storage');
        $fxparam['fx_goods_id'] = $fx_goods_info['fx_goods_id'];
        $fxparam['goods_storage'] = $fx_goods_info['goods_storage'] + $goods_num['goods_num'];
        $fxparam['items_storage'] = $fx_goods_info['items_storage'] + $goods_num['goods_num'];
        $model_fx_goods->updateGoods($fxparam);

        //直营店减少库存
        $model_goods = Model('goods');
        $condition['goods_id'] = $goods_num['goods_id'];
        $info = $model_goods->getGoodsInfo($condition, $field = 'goods_storage,items_storage');
        $update['goods_storage'] = $info['goods_storage'] - $goods_num['goods_num'];
        $update['items_storage'] = $info['items_storage'] - $goods_num['goods_num'];
