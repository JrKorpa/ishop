...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3><?php echo $lang['flea_index_setting'];?></h3>
      <ul class="tab-base">
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['flea_index_seo_setting'];?></span></a></li>
      </ul>
    </div>
  </div>
  ...
  <form method="post" enctype="multipart/form-data" name="form1">
    ...
    <table class="table tb-type2">
      <tbody>
        <tr class="noborder">
          <td colspan="2" class="required"><label for="flea_site_name"><?php echo $lang['flea_site_name'];?>:</label></td>
        </tr>
        <tr class="noborder">
        ...
        <tr>
          <td colspan="2" class="required"><label for="flea_site_title"><?php echo $lang['flea_site_title'];?>:</label></td>
        </tr>
        <tr class="noborder">
        ...
        <tr>
          <td colspan="2" class="required"><label for="flea_site_description"><?php echo $lang['flea_site_description'];?>:</label></td>
        </tr>
        <tr class="noborder">
        ...
        <tr>
          <td colspan="2" class="required"><?php echo $lang['flea_site_keywords'];?>:</td>
        </tr>
        <tr class="noborder">
        ...
        <tr>
          <td colspan="2" class="required"><label for="flea_hot_search"><?php echo $lang['flea_hot_search'];?>:</label></td>
        </tr>
        <tr class="noborder">
