...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3><?php echo $lang['flea_ldle'];?></h3>
      <ul class="tab-base">
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['flea_all_ldle'];?></span></a></li>
      </ul>
    </div>
  </div>
  ...
  <form method="get" name="formSearch">
    ...
    <table class="tb-type1 noborder search">
      <tbody>
        <tr>
          <th><label for="search_goods_name"> <?php echo $lang['flea_ldle_name'];?></label></th>
		  ...
		  <th><label for="search_member_name"> <?php echo $lang['flea_release_member'];?></label></th>
  ...
  <form method='post' id="form_goods">
    ...
    <table class="table tb-type2">
      <thead>
        <tr class="thead">
          <th width="25px"></th>
          <th colspan="2"><?php echo $lang['flea_ldle_name'];?></th>
		  <th><?php echo $lang['flea_release_member'];?></th>
      ...
      <tbody>
        ...
        <tr class="hover edit">
		  ...
		  <div class="size-56x56"><span class="thumb size-56x56"><img height="56" width="56"
                                                                      src="<?php echo $v['goods_image']
                                                                          ? UPLOAD_SITE_URL.'/flea/'.$v['member_id'].'/'.str_replace('_small', '_tiny', $v['goods_image'])
                                                                          : BASE_RESOURCE_PATH . '/images/default_goods_image.gif';?>"
          ...
          <td class="w48 align-center"><a href="<?php echo BASE_SITE_URL;?>/index.php?act=flea_goods&goods_id=<?php echo $v['goods_id'];?>" target="_blank"><?php echo $lang['nc_view'];?></a></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
        <tr class="no_data">
...
<script type="text/javascript" src="<?php echo ADMIN_RESOURCE_URL;?>/js/common_flea_select.js" charset="utf-8"></script>
