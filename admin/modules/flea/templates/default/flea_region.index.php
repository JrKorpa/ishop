...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3><?php echo $lang['region_index_config'];?></h3>
      <ul class="tab-base">
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['nc_manage'];?></span></a></li>
        <li><a href="javascript:void(0)" onclick="if(confirm('<?php echo $lang['region_index_import_tip'];?>?')){location.href='../../../../../index.php';}"><span><?php echo $lang['region_index_import_region'];?></span></a></li>
      </ul>
    </div>
  </div>
   ...
   <table class="table tb-type2" id="prompt">
    <tbody>
      ...
      <tr>
        <td>
        <ul>
            <li><?php echo $lang['region_index_help2'];?></li>
          </ul></td>
      </tr>
    </tbody>
  </table> 
  <table class="tb-type1 noborder search">
    <tbody>
      <tr>
        <th><label><?php echo $lang['region_index_choose_region'];?></label></th>
        <td><select name="province" id="province" onchange="refreshdistrict($(this).val(),'province')">
			<option value="" <?php if($output['province'] == ''){ ?>selected='selected'<?php }?>>-<?php echo $lang['region_index_province'];?>-</option>
		  ...
		  <select name="city" id="city" onchange="refreshdistrict($(this).val(),'city')">
			<option value="" <?php if($output['city'] == ''){ ?>selected='selected'<?php }?>>-<?php echo $lang['region_index_city'];?>-</option>
  ...
  <form method="post" id='form_area_list';>
    ...
    <table class="table tb-type2">
      <thead>
        <tr class="thead">
          <th class="align-center"><?php echo $lang['nc_sort'];?></th>
          <th><?php echo $lang['region_index_name'];?></th>
