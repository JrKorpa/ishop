...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3><?php echo $lang['flea_index_class_setting'];?></h3>
      <ul class="tab-base">
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['flea_index_class_setting_info'];?></span></a></li>
      </ul>
    </div>
  </div>
  ...
  <form method="post" enctype="multipart/form-data" name="form1">
    ...
    <table class="table tb-type2">
      <tbody>
        <tr class="noborder">
          <td colspan="2" class="required"><label for="flea_site_name"><?php echo $lang['flea_index_class_setting_digital'];?>:</label></td>
        </tr>
        <tr class="noborder">
          ...
          <td class="vatop tips"><span class="vatop rowform"><?php echo $lang['flea_class_index_tips'];?></span></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform" style="width: 600px">
        ...
        <tr>
          <td colspan="2" class="required"><label for="flea_site_title"><?php echo $lang['flea_index_class_setting_beauty'];?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform" style="width: 600px">
        ...
        <tr>
          <td colspan="2" class="required"><label for="flea_site_description"><?php echo $lang['flea_index_class_setting_home'];?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform" style="width: 600px">
        ...
        <tr>
          <td colspan="2" class="required"><?php echo $lang['flea_index_class_setting_interest'];?>:</td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform" style="width: 600px">
        ...
        <tr>
          <td colspan="2" class="required"><label for="flea_hot_search"><?php echo $lang['flea_index_class_setting_baby'];?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform" style="width: 600px">
