<?php defined('INTELLIGENT_SYS') or exit('Access Invalid!');?>
  ...
  <form id="attr_form" method="post" class="ncap-form-dialog" action="<?php echo urlAdminShop('type', 'attr_edit');?>">
    ...
    <div class="ncap-form-default">
      ...
      <dl class="row">
        <dt class="tit">
          <label><?php echo $lang['type_edit_type_attr_type'];?></label>
        </dt>
        <dd class="opt">
          <div>
			      <input id="attr_type1" name="attr_type" <?php if($output['attr_info']['attr_type'] == '1'){?>checked="checked"<?php }?> value="1" type="radio" />
            <label for="attr_type1"><?php echo $lang['type_edit_type_attr_type_single'];?></label>
            <input id="attr_type2" name="attr_type" <?php if($output['attr_info']['attr_type'] == '2'){?>checked="checked"<?php }?> value="2" type="radio" />
            <label for="attr_type2"><?php echo $lang['type_edit_type_attr_type_multi'];?></label>
            <input id="attr_type3" name="attr_type" <?php if($output['attr_info']['attr_type'] == '3'){?>checked="checked"<?php }?> value="3" type="radio" />
            <label for="attr_type3"><?php echo $lang['type_edit_type_attr_type_input'];?></label>  
          </div>
          <span class="err"></span>
          <p class="notic"></p>
        </dd>
