  ...
  <div class="content">
    <div class="scroll switchbox" >
      <ul class="tema">
        <li>
          <h4>源码提供 - </h4>
          <p>唯一官方网：<a href="http://官网" target="_blank">http://官网</a></p>
          <p>唯一淘宝店：<a href="http://官网" target="_blank">http://kelancom.taobao.com</a></p>
          <p>唯一旺旺名：kelan</p>
          <p>唯一QQ总群：官网群</p>
    ...
    <div class="scrollbar switchbox" style="display: none;">
      <div class="law-notice">
        <p>程序来源：网店交流中心 <a href="http://官网" target="_blank">http://官网</a>。</p>
          感谢您选择B2B2C电商平台系统。希望我们的努力能为您提供一个高效快速和强大的企业级电子商务整体解决方案。</p>
        <p>B2B2C系统是根据网城天创系统进化而来！对本版本只用户学习和研究，您使用过程中产生的利益与(kelan.com)无关，我们不负任何法律责任！</p>
        <p>为了你更好的使用本系统！请加入QQ群官网群</p>
        <p>尊爱网络环境！禁止非法传播。</p>
      </div>
    </div>
    <div class="switchbox" style="display:none;" >
      <ul>
        ...
        <li>
          <h4>关注我们</h4>
          <p><?php echo $lang['dashboard_aboutus_website'];?> <a href="http://官网" target="_blank">http://官网</a></p>
