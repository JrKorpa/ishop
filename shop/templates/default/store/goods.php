    ...
    <div class="ncs-intro">
      <div class="content bd" id="ncGoodsIntro">
        ...
        <ul class="nc-goods-sort">
          <li>款号：<?php echo $output['goods']['goods_serial'];?></li>
          ...
          <?php foreach ($output['goods']['goods_attr'] as $val){ $val= array_values($val);$label = $val[0]; unset($val[0]); echo '<li>'.$label.$lang['nc_colon'].implode('，',$val).'</li>'; }?>
          <?php }?>
