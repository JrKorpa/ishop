  ...
  <div class="ncsc-flow-container">
    ...
    <div id="saleRefundReturn">
      ...
      <div class="ncsc-form-default">
        ...
        <?php if($output['return']['order_sn']){?>
        <dl>
          <dt>退款类型：</dt>
          <dd><?php if($output['return']['return_form'] == 1){ ?>现金<?php }elseif($output['return']['return_form'] == 2){ ?>打卡<?php }elseif($output['return']['return_form'] == 3){ ?>转单<?php }else{?><?php }?></dd>
        </dl>
        <dl>
          <dt>申请人（买家）：</dt>
        ...
        <dl>
          <dt>货号：</dt>
          <dd><?php echo $output['return']['goods_id']; ?></dd>
        </dl>
        <dl>
          <dt>货品名称：</dt>
        ...
        <!--<dl>
          <dt>入库仓库：</dt>
          <dd><?php echo $output['return']['to_house_id']; ?></dd>
        </dl>-->
        <?php }?>
        <dl>
        ...
        <dl>
          <dt>退款违约金：</dt>
          <dd><?php echo $lang['currency'];?><?php echo $output['breach_amount']; ?> </dd>
        </dl>
        <?php }else{?>
        <dl>
          <dt>销售价：</dt>
          <dd><?php echo $lang['currency'];?><?php echo $output['return']['sales_price']; ?></dd>
        </dl>
        <?php }?>
        <dl>
        ...
        <form id="post_form" method="post" action="index.php?act=store_return&op=edit&return_id=<?php echo $output['return']['refund_id']; ?>">
          ...
          <dl>
            <dt><i class="required"></i>入库仓库<?php echo $lang['nc_colon'];?></dt>
            <dd>
