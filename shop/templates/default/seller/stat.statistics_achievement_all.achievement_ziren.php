...
<div class="stat_fie_box">
   <div class="stat_inn_box">
		<div class="stat_inn_tab">
			<dl>
			    <dt>业绩统计</dt>
				<dd ><a href="index.php?act=statistics_achievement_all&op=achievement">统计表(总)</a></dd>	
				<dd><a href="index.php?act=statistics_achievement_all&op=achievement_yiye">异业客户(总)</a></dd>	
				<dd class="active"><a href="index.php?act=statistics_achievement_all&op=achievement_ziren">自然进店(总)</a></dd>	
...
$(function(){
	...
	$('#statlist1').load('index.php?act=statistics_achievement&op=achievement_ziren_list&start_date=<?php echo $output['search_arr']['start_date'];?>&end_date=<?php echo $output['search_arr']['end_date'];?>');
