...
<dl>
  <dt><em class="pngFix"></em>折扣码名称：</dt>
...
<dl>
  <dt><em class="pngFix"></em>商品类型：</dt>
  <dd><?php echo paramsHelper::echoOptionText('voucher_goods_type',$output['t_info']['voucher_t_goods_type']);?></dd>
</dl>
<dl>
...
<dl>
  <dt><?php echo str_replace(array(1,2),array("折扣：","面额："),$output['t_info']['voucher_t_type']); ?></dt>
  <dd><?php echo $output['t_info']['voucher_t_price'];?>&nbsp;<?php echo str_replace(array(1,2),array("%","元"),$output['t_info']['voucher_t_type']); ?></dd>
</dl>
...
<dl>
    <dt ><em class="pngFix"></em>折扣码类型：</dt>
    <dd><?php echo str_replace(array(1,2),array("折扣码","成品定制码"),$output['t_info']['voucher_t_type']); ?></dd>
</dl>
...
<dl>
  ...
  <dd>未生成&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            <a href="javascript:void(0);" id="build_voucher">点击生成折扣码卡密</a></dd>
</dl>
<?php } ?>
...
<script>
    ...
    <p class="hint">可以复制该链接对免费领取折扣码进行推广</p>
  </dd>
</dl>
--><?php /*} */?>
