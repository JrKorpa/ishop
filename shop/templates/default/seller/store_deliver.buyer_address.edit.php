...
$(document).ready(function(){
    window.setTimeout(function(){
        $('#new_mob_phone').val('<?php echo  $output['address_info']['reciver_info']['mob_phone'];?>');
        $('#new_tel_phone').val('<?php echo $output['address_info']['reciver_info']['tel_phone'];?>');
        $('#new_area').val('<?php echo $output['address_info']['reciver_info']['area'];?>');
        $('#new_street').val('<?php echo $output['address_info']['reciver_info']['street'];?>');
        $('#new_reciver_name').val('<?php echo $output['address_info']['reciver_name'];?>');
    },300)
