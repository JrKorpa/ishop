        ...
        <dd>
          <?php foreach ($output['attr_list'] as $k=>$val){?>
            ...
            <?php if(is_array($val) && !empty($val)){?>
              ...
              <?php } else if ($val['attr_type'] == 2) {?>
                <?php foreach ($val['value'] as $v){?>
                  <input type="checkbox" id="attr[<?php echo $k;?>][<?php echo $v['attr_value_id']?>]" name="attr[<?php echo $k;?>][<?php echo $v['attr_value_id']?>]" value="<?php echo $v['attr_value_name']?>" <?php echo isset($output['attr_checked']) && in_array($v['attr_value_id'],$output['attr_checked'])?"checked":''?>/>
                  <label for="attr[<?php echo $k;?>][<?php echo $v['attr_value_id']?>]"><?php echo $v['attr_value_name']?></label>
                <?php }?>
              <?php } ?>
            <?php }?>
            </span>
            <?php if(!empty($val) && $val['attr_type']==2){?><br/><?php }?>
          <?php }?>
        </dd>
      </dl>
      <?php }?>
