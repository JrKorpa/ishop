   ...
   <div class="stat_inn_box">
		<div class="stat_inn_tab">
			<dl>
				...
				<dd class="active"><a href="index.php?act=statistics_sale&op=statistics">销售统计</a></dd>	
		...
		<div class="alert alert-info mt10" style="clear:both;">
			...
			<li>
				...
				<span class="w210 fl h30" style="display:block;">
					...
					发货金额：<strong><?php echo $output['statcount_arr']['sum_real_amount'];?></strong>
				</span>
				<span class="w210 fl h30" style="display:block;">
...
$(function(){
	...
	$('#statlist').load('index.php?act=statistics_sale&op=statisticslist&t=<?php echo $output['searchtime'];?>&order_state=<?php echo $_REQUEST['order_state'];?>&is_zp=<?php echo $_REQUEST['is_zp'];?>&source_id=<?php echo $_REQUEST['source_id'];?>&fenlei=<?php echo $_REQUEST['fenlei'];?>&seller_id=<?php echo $_REQUEST['seller_id'];?>');
});
</script>