      ...
      <dl>
        <dt>
          ...
          <a><!--target="_blank" href="<?php echo urlShop('goods','index',array('goods_id'=> $val['goods_id'])); ?>"-->
            <img src="<?php echo empty($val["goods_image"])?$output["default_img_url"]:$val["goods_image"];?>" width="100" height="100" onMouseOver="toolTip('<img src=<?php echo empty($val["goods_image"])?$output["default_img_url"]:$val["goods_image"];?>>')" onMouseOut="toolTip()" /></a></div>
        </dt>
        <dd><a><!--target="_blank" href="<?php echo urlShop('goods','index',array('goods_id'=> $val['goods_id'])); ?>"--><?php echo $val['goods_name']; ?></a>
            <?php echo $val['goods_itemid']; ?><br/><?php echo $lang['currency'];?><?php echo ncPriceFormat($val['goods_price']); ?> * <?php echo $val['goods_num']; ?> <font color="#AAA">(数量)</font>
