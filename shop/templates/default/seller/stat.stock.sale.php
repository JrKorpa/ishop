   ...
   <div class="stat_inn_box">
		<div class="stat_inn_tab">
			<dl>
				...
				<dd class="active"><a href="index.php?act=statistics_stock&op=sale_stock">可销售库存统计</a></dd>	
			</dl>
			
		</div>
		<div class="alert mt10" style="clear:both;">
			<ul class="mt5">
				<li> 1、统计可销售的库存及产品分类占比情况</li>
...
$(function(){
	...
	var stat_json1 = <?php echo $output['stat_json1']; ?>;

	console.log(stat_json1);
	 $('#container1').highcharts(stat_json1);
	<?php } ?>
