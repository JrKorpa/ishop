   ...
   <div class="stat_inn_box">
		<div class="stat_inn_tab">
			<dl>
				...
				<dd class="active"><a href="index.php?act=statistics_achievement_all&op=achievement_yiye">异业客户(总)</a></dd>	
...
$(function(){
	...
	$('#statlist1').load('index.php?act=statistics_achievement&op=achievement_yiye_list&start_date=<?php echo $output['search_arr']['start_date'];?>&end_date=<?php echo $output['search_arr']['end_date'];?>');
