...
<Script type="text/javascript" src="<?php echo RESOURCE_PATH.'/js/flea/slider.js';?>" charset="utf-8"></Script>
<link href="<?php echo TEMPLATES_PATH;?>/css/flea_info.css" rel="stylesheet" type="text/css">

<script charset="utf-8" type="text/javascript" src="<?php echo RESOURCE_PATH;?>/js/jquery.jqzoom.js" ></script>
<script charset="utf-8" type="text/javascript" src="<?php echo RESOURCE_PATH;?>/js/flea/goodsinfo.js"></script> 
<script type="text/javascript" src="<?php echo RESOURCE_PATH;?>/js/dialog/dialog.js" id="dialog_js" charset="utf-8"></script>
<link type="text/css" rel="stylesheet" href="<?php echo RESOURCE_PATH;?>/js/dialog/dialog.css">
<script>
        ...
        <?php if(!empty($output['goods_commend']) && is_array($output['goods_commend'])){?>
            ...
            <span class="thumb size76">
              ...
              <a href="index.php?act=flea_goods&type=goods&goods_id=<?php echo $comment_goods['goods_id'];?>">
              	<img height="76" width="76" onload="javascript:DrawImage(this,76,76);" src="<?php echo $comment_goods['goods_image'] != '' ? ATTACH_FLEAS.DS.$comment_goods['member_id'].DS.$comment_goods['goods_image'] : ATTACH_COMMON.DS.$GLOBALS['setting_config']['default_goods_image'];?>" title="<?php echo $comment_goods['goods_name'] ?>" />
              </a>
			</span>
      ...
      <div class="ware_pic">
        <div class="big_pic"><i><a href="javascript:void(0)">
        	<span class="jqzoom">
        		...
        		<img height="300" width="300" src="<?php if (empty($output['desc_image'])){ echo ATTACH_COMMON.DS.$GLOBALS['setting_config']['default_goods_image']; }else{ echo $output['goods_image']['thumb_mid'];} ?>" onerror="this.src='<?php echo ATTACH_COMMON.DS.$GLOBALS['setting_config']['default_goods_image']; ?>'" onload="javascript:DrawImage(this,300,300);" jqimg="<?php echo $output['goods_image']['thumb_max']; ?>" />
          ...
          <div class="ware_box">
            <ul>
              ...
              <li <?php if($key == 0) { ?>class="ware_pic_hover"<?php } ?> bigimg="<?php echo $val['thumb_max']; ?>">
              	<span class="thumb size40"><i></i><img height="40" width="40" src="<?php echo $val['thumb_small']; ?>" onerror="this.src='<?php echo ATTACH_COMMON.DS.$GLOBALS['setting_config']['default_goods_image'];?>'" onload="javascript:DrawImage(this,40,40);" /></span>
              </li>
        <?php
			  	}
			  }
 ...
 <div class="share">
   ...
   <span><a href="#" class="blue" onclick="javascrit:collect_flea(<?php echo $output['goods']['goods_id'];?>);return false;"><?php echo $lang['flea_goods_collect_goods'];?></a></span>    </div>  
        ...
        <div id="contact" class="grey-box">
          <div class="bd">
            <ul class="fn-clear">
              ...
              <li><?php echo $lang['flea_contact_tel'];?>: <img style="vertical-align: middle;" src="<?php echo RESOURCE_PATH; ?>/pnum.php?pnum=<?php echo $output['goods']['flea_pphone']?>"></li>
            </ul>
    ...
    <div id="seller_info" class="flea_gray mb10">
      ...
      <p><?php echo $lang['flea_store_owner'];?>:<?php echo $output['flea_member_info']['member_name'];?><a href="index.php?act=home&op=sendmsg&member_id=<?php echo $output['flea_member_info']['member_id'];?>" target=_blank><img src="<?php echo TEMPLATES_PATH;?>/images/web_mail.gif"></a></p>
    </div>
    <div id="seller_info" class="flea_gray mb10">
        ...
        <div class="flea_goods">
           <div class="pic">
             <span class="thumb size60">
               <i></i>
               <a title="<?php echo $val['goods_name']?>" href="index.php?act=flea_goods&type=goods&goods_id=<?php echo $val['goods_id']?>"><img height="60" width="60" src="<?php echo $val['goods_image'] != '' ? ATTACH_FLEAS.DS.$val['member_id'].DS.$val['goods_image'] : ATTACH_COMMON.DS.$GLOBALS['setting_config']['default_goods_image'];?>" onload="javascript:DrawImage(this,60,60);"></a>
             </span>
           </div>
           <dl>
...
<?php echo $output['goods']['goods_body'];?>
  ...
  <div id="comments-content">
     ...
     <input type="hidden" value="" name="type_name">
       <div class="comment-user"><img src="<?php $member_avatar = Model('member')->infoMember(array('member_id'=>$_SESSION['member_id']),'member_avatar'); if ($member_avatar['member_avatar']!='') { echo ATTACH_AVATAR.DS.$member_avatar['member_avatar']; } else {  echo ATTACH_COMMON.DS.$GLOBALS['setting_config']['default_user_portrait']; } ?>"></div>
     ...
     <?php foreach ($output['consult_list'] as $val){?>
       <li>
         <div class="comment-user"><img src="<?php $member_avatar = Model('member')->infoMember(array('member_id'=>$val['member_id']),'member_avatar'); if ($member_avatar['member_avatar']!='') { echo ATTACH_AVATAR.DS.$member_avatar['member_avatar']; } else {  echo ATTACH_COMMON.DS.$GLOBALS['setting_config']['default_user_portrait']; } ?>"></div>
