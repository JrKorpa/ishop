...
<Script type="text/javascript" src="<?php echo RESOURCE_PATH;?>/js/easySlider1.7.js" charset="utf-8"></Script>
...
<script type="text/javascript" src="<?php echo RESOURCE_PATH;?>/js/jquery.flea_list.js"></script>
        ...
        <li class=" seller_goods fn-left">
          <p class="pic fn-left">
             <span class="thumb size120">
               <i></i>
               <a class="user" href="index.php?act=flea_goods&goods_id=<?php echo $val['goods_id'];?>"><img height="120" width="120" onload="javascript:DrawImage(this,120,120);" title="<?php echo $val['goods_name'];?>" src="<?php echo $val['image_url'];?>"/></a>                
             </span>
          </p>
          ...
          <div class="seller fn-left">
            <div class="pic fn-left">
              <span class="thumb size50">
                <i></i>
                <a href="index.php?act=flea_class&seller_input=<?php echo $val['member_info']['member_id'];?>&pic_input=1"><img height="50" width="50" onload="javascript:DrawImage(this,50,50);" src="<?php echo $val['member_info']['avatar'];?>" /></a>
              </span>
            </div>
            <p class="seller_name">
					...
					<li class="sell_one">
					  <div>
						<p class="pic1">
						  ...
						  <a href="index.php?act=flea_class&seller_input=<?php echo $val['member_id'];?>">
								<img width="20" height="20" onload="javascript:DrawImage(this,20,20);" src="<?php echo $val['member_avatar']?ATTACH_AVATAR.'/'.$val['member_avatar']:TEMPLATES_PATH.'/images/default_user_portrait.gif';?>" />
							</a>              
						  </span>
						</p>
					  ...
					  <div class="items_info">
						<div class="pic2 fn-left">
						  <span class="thumb size50">
							<a href="index.php?act=flea_goods&goods_id=<?php echo $val['goods_id'];?>">
								<img height="48" width="48" onload="javascript:DrawImage(this,48,48);" title="<?php echo $val['goods_name'];?>" src="<?php echo $val['goods_image']?ATTACH_PATH.'/flea/goods/'.$val['member_id'].'/'.$val['goods_image']:TEMPLATES_PATH.'/images/default_goods_image.gif';?>" />
							</a>
						  </span>
						</div>
				...
				<li>
				  <div class="pic fn-left">
					<span class="thumb size60">
					  <i></i>
					  <a href="index.php?act=flea_goods&goods_id=<?php echo $val['goods_id'];?>">
						<img height="60" width="60" onload="javascript:DrawImage(this,60,60);" title="<?php echo $val['goods_name'];?>" src="<?php echo $val['goods_image']?ATTACH_PATH.'/flea/goods/'.$val['member_id'].'/'.$val['goods_image']:TEMPLATES_PATH.'/images/default_goods_image.gif';?>" />
					  </a>
					</span>
				  </div>
				  <h3 class="fn-right">
