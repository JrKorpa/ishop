...
<script src="<?php echo RESOURCE_PATH;?>/js/common.js" type="text/javascript" charset="utf-8"></script>
...
<div id="category">
  <div class="content">
    <ul>
      <li>
        <div class="items_pic"><img src="<?php echo TEMPLATES_PATH;?>/images/flea/cat.gif" /></div>
        <div class="cat_list">
      ...
      <li>
        <div class="items_pic"><img src="<?php echo TEMPLATES_PATH;?>/images/flea/cat2.gif" /></div>
        <div class="cat_list">
      ...
      <li>
        <div class="items_pic"><img src="<?php echo TEMPLATES_PATH;?>/images/flea/cat3.gif" /></div>
        <div class="cat_list">
      ...
      <li>
        <div class="items_pic"><img src="<?php echo TEMPLATES_PATH;?>/images/flea/cat4.gif" /></div>
        <div class="cat_list">
      ...
      <li>
        <div class="items_pic"><img src="<?php echo TEMPLATES_PATH;?>/images/flea/cat5.gif" /></div>
        <div class="cat_list">
...
<div class="flea_goods content">
  <div id="first_items">
      <div id=idContainer2 class=container>
		<script type="text/javascript" src="<?php echo SiteUrl;?>/index.php?act=adv&op=advshow&ap_id=1037"></script>
  </div>
      <div class="hotgoods">
        ...
        <div class="hotgoods_G">
          <dl>
            <dt class="fn-left">
              <div class="pic">
                <span class="thumb size100">
                  <i></i>
                  <a title="<?php echo $output['new_flea_goods']['goods_name'];?>" target="_blank" href="index.php?act=flea_goods&goods_id=<?php echo $output['new_flea_goods']['goods_id']?>"><img height="100" width="100" onload="javascript:DrawImage(this,100,100);" src="<?php echo $output['new_flea_goods']['goods_image'] != '' ? ATTACH_FLEAS.DS.$output['new_flea_goods']['member_id'].DS.$output['new_flea_goods']['goods_image'] : ATTACH_COMMON.DS.$GLOBALS['setting_config']['default_goods_image'];?>" /></a>
                </span>
              </div>
            </dt>
            ...
            <dd class="fn-left"><img src="<?php echo TEMPLATES_PATH;?>/images/flea/zr.png" /></dd>
              ...
              <div class="collect_goods">
                ...
                <div class="pic fn-left">
                  <span class="thumb size76">
                    <i></i>
                    <a title="<?php echo $output['col_flea_goods']['goods_name'];?>" href="index.php?act=flea_goods&goods_id=<?php echo $output['col_flea_goods']['goods_id']?>" target="_blank"><img height="76" width="76" onload="javascript:DrawImage(this,76,76);" src="<?php echo $output['col_flea_goods']['goods_image'] != '' ? ATTACH_FLEAS.DS.$output['col_flea_goods']['member_id'].DS.$output['col_flea_goods']['goods_image'] : ATTACH_COMMON.DS.$GLOBALS['setting_config']['default_goods_image'];?>" /></a>
                  </span>
                </div>
  ...
  <div class="ad"><script type="text/javascript" src="<?php echo SiteUrl;?>/index.php?act=adv&op=advshow&ap_id=1038"></script></div> 
  ...
  <div id="fourth_items">
    <h2></h2>
    <ul>
      <li class="fn-left"><script type="text/javascript" src="<?php echo SiteUrl;?>/index.php?act=adv&op=advshow&ap_id=1043"></script></li>
      <li class="fn-left"><script type="text/javascript" src="<?php echo SiteUrl;?>/index.php?act=adv&op=advshow&ap_id=1044"></script></li>
      <li class="fn-left"><script type="text/javascript" src="<?php echo SiteUrl;?>/index.php?act=adv&op=advshow&ap_id=1045"></script></li>
      <li class="last fn-left"><script type="text/javascript" src="<?php echo SiteUrl;?>/index.php?act=adv&op=advshow&ap_id=1046"></script></li>
    </ul>
  </div>
  <div class="fn-clear"></div>
  <div id="five_items">
                  ...
                  <ul>
                    ...
                    <li>
                      <div class="pic">
                        <span class="thumb size120">
                          <i></i>
                          <a target="_blank" title="<?php echo $v['goods_name'];?>" href="index.php?act=flea_goods&goods_id=<?php echo $v['goods_id']?>"><img height="120" width="120" onload="javascript:DrawImage(this,120,120);" src="<?php echo $v['goods_image'] != '' ? ATTACH_FLEAS.DS.$v['member_id'].DS.$v['goods_image'] : ATTACH_COMMON.DS.$GLOBALS['setting_config']['default_goods_image'];?>" /></a>                        </span>                      </div>
