...
$(function(){
	...
	if ($.cookie('flea_area') != null && $.cookie('flea_area') != ''){
		...
		$('#show_area').html('<?php echo $lang['flea_yz_country']?>');
	}
});
...
<header id="topHeader">
  ...
  <!--地区-->
  <span id="cityname" ><h1><?php echo $lang['nc_flea_index'];?></h1></span>
...
<div id="navBar" class="mb10">
  ...
  <?php } ?>
    ...
    <?php }?> 
	<li <?php echo $output['index_sign'] == 'flea'&&$output['index_sign'] != '0'?'class="current"':'class="link"'; ?> style="float:right"><a href="http://115.29.45.198"><span>微生活社区</span></a></li>
  </ul>
  <!--地区-->
