  ...
  <div class="wrapper">
    <div class="ncsc-admin">
      ...
      <div class="ncsc-admin-function">
          <!--<a href="<?php echo urlShop('show_store', 'index', array('store_id'=>$_SESSION['store_id']), $output['store_info']['store_domain']);?>" title="前往店铺" ><i class="icon-home"></i></a>-->
          <a href="<?php echo WAP_SITE_URL;?>" title="前往店铺" ><i class="icon-home"></i></a>
          <!--<a href="<?php echo urlMember('member_security', 'auth',array('type'=>'modify_pwd'));?>" title="修改密码" target="_blank"><i class="icon-wrench"></i></a>-->
		   <a href="javascript:void(0)"  nc_type="dialog" dialog_title="修改密码" dialog_id="change_pwd"  uri="index.php?act=seller_center&op=change_pwd" dialog_width="400" title="修改密码"><i class="icon-wrench"></i></a>
          <a href="<?php echo urlShop('seller_logout', 'logout');;?>" title="安全退出"><i class="icon-signout"></i></a>
      </div>
    </div>
