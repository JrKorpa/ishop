...
<title><?php if (!empty($q)) echo "搜索：" . strip_tags($q) . " - "; ?>ishop 搜索 - Powered by @package_name@</title>
  ...
  <div class="row">
    ...
    <div class="span12">
      ...
      <dl class="result-list">
        ...
        <dt>
          <a href="javascript:void(alert('pid: <?php echo $doc->id; ?>'));"><h4><?php echo $doc->rank(); ?>. <?php echo $search->highlight(htmlspecialchars($doc->goods_name)); ?> <small>[<?php echo $doc->percent(); ?>%]</small></h4></a>
        </dt>
        <dd>
          <p><?php echo $search->highlight(htmlspecialchars($doc->gc_name)); ?></p>
...
<footer>
  <div class="container">
    <p>(C)opyright 2011 - @project_name@ search - 页面处理总时间：<?php printf('%.4f', $total_cost); ?>秒<br>
      Powered by <a href="http://www.xunsearch.com/" target="_blank" title="开源免费的中文全文检索"><?php echo PACKAGE_NAME . '/' . PACKAGE_VERSION; ?></a></p>
  </div>
</footer>
