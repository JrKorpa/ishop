...
class cacheModel extends Model {
    ...
    private function _admin_menu() {
        ...
        if (file_exists(BASE_PATH.DS.ADMIN_MODULES_CRM.'/include/menu.php')) {
            require(BASE_PATH.DS.ADMIN_MODULES_CRM.'/include/menu.php');
        }
        ...
        if (file_exists(BASE_PATH.DS.ADMIN_MODULES_AGENT.'/include/menu.php')) {
            require(BASE_PATH.DS.ADMIN_MODULES_AGENT.'/include/menu.php');
        }
    ...
    private function _agent_menu() {
        Language::read('layout');
        $lang = Language::getLangContent();
        if (file_exists(BASE_PATH.DS.'/include/menu.php')) {
            require(BASE_PATH.DS.'/include/menu.php');
        }
        return $_menu;
    }
    /**
