...
class tradeModel extends Model{
    ...
    public function getOrderState($type = 'all') {
        $state_data = array(
            ...
            'order_confirm' =>ORDER_STATE_TO_CONFIRM,//5:待确认
            'order_default' => ORDER_STATE_NEW,//10:未付款
            'order_making' => ORDER_STATE_MAKING,//15:生产中
            'order_sign' =>ORDER_STATE_TO_SIGN,//16:待签收
            'order_paid' => ORDER_STATE_PAY,//20:已付款
            'order_tosend' =>ORDER_STATE_TOSEND,//待发货
