...
class typeModel extends Model {
    ...
    public function getAttr($type_id, $store_id, $gc_id) {
        ...
        if ($type_id > 0) {
            ...
            $attr_list = $this->typeRelatedJoinList(array('attribute.type_id' => $type_id), 'attr', 'attribute.attr_id as attr_id, attribute.attr_type, attribute.attr_name as attr_name, attribute_value.attr_value_id as attr_value_id, attribute_value.attr_value_name as attr_value_name');
            ...
            if (is_array($attr_list) && !empty($attr_list)) {
                ...
                foreach ($attr_list as $val) {
                    ...
                    $array[$val['attr_id']]['attr_type'] = $val ['attr_type'];
