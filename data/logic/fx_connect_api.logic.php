...
class fx_connect_apiLogic {
    ...
    public function getWxOAuth2Url(){
        ...
        $api_url = 'https://open.weixin.qq.com/connect/oauth2/authorize?appid='.$weixin_appid.
            '&redirect_uri='.urlencode(MOBILE_SITE_URL.'/index.php?act=fx_connect&op=index').
    ...
    public function getSinaOAuth2Url($sina_type = ''){
        ...
        $api_url = RESOURCE_SITE_URL.'/api/sina/fx_return_url.php';
        $sina_url = '';
    ...
    public function getQqOAuth2Url($qq_type = ''){
        ...
        $api_url = RESOURCE_SITE_URL.'/api/qq/fx_return_url.php';
        $qq_url = '';
