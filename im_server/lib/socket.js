...
Socket.prototype.set = function(key, val) {
  this._cache[key] = val;
};

Socket.prototype.get = function(key) {
  console.log("socket cache data:");
  console.log(this._cache);
  return typeof this._cache[key] != 'undefined' ? this._cache[key] : null;
}
...
Socket.prototype.online = function(user, fn) {
  var self = this;
}
...
/**
 *　Add a function to cache the user information in a list
 *
 */