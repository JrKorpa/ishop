$(function(){
   ...
   if(!key){
	...
	function initStyleGallery(style_sn){
		$.ajax({
			url:ApiUrl+"/index.php?act=couple_goods&op=get_style_gallery",
			type:'post',
	...
	function initStyleGoodsInfo(goods_sn){
		$.ajax({
			url:ApiUrl+"/index.php?act=couple_goods&op=get_style_goods_detail",
			type:'post',
	...
	function initStyleGoodsPrice(style_sn,caizhi,yanse,xiangkou,shoucun){
		$.ajax({
			url:ApiUrl+"/index.php?act=couple_goods&op=get_style_goods_price",
			type:'post',
