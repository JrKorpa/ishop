...
$(function() {
    ...
    function o() {
        ...
        $.sDialog({
		    skin: "red",
            content: "修改订单价格<h6>买家："+bn+"</h6><h6>订单号："+os+"</h6><h6>输入新价格:<input type='tel' name='newprice' id='newprice' style='width:2rem;padding-left:1rem;height:1rem;IME-MODE:disabled;'></h6>",
            okFn: function() {
