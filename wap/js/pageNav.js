...
function PageNavCreate(id,props){
    ...
    if(this.pageCount<=this.perPageNum){
        ...
        $('<li class="page-nav-first">'+
              '<a href="javascript:void(0)" aria-label="First page" pagenum="1" >'+
                '<span aria-hidden="true">&laquo;</span>'+
              '</a>'+
            '</li>'+
            '<li class="page-nav-prev">'+
                '<a href="javascript:void(0)" aria-label="Previous" pagenum="'+
        ...
        for(var i =1; i<=this.pageCount; i++){
            $('<li class="pageNum" ><a href="javascript:void(0)"  pagenum="'+i+'" >'+i+'</a></li>').appendTo(this.pageNavUl);
        ...
        $('<li class="page-nav-next">'+
              '<a href="javascript:void(0)" aria-label="Last page"  pagenum="'+
            ...
            '<li class="page-nav-last">'+
              '<a href="javascript:void(0)" aria-label="Last page"  pagenum="'+this.pageCount+'" >'+
