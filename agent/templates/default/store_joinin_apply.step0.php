...
<div id="apply_agreement" class="apply-agreement">
  <div class="title"><h3>申请协议</h3></div>
  ...
  <div class="bottom"><a id="btn_apply_agreecbc_next" href="javascript:;" class="btn">立即申请</a></div>
</div>
<script type="text/javascript">
$(document).ready(function(){
	$('#btn_apply_agreecbc_next').on('click', function() {
        if($('#input_apply_agreement').prop('checked')) {
            window.location.href = "index.php?act=agent_register&op=step1";
        } else {
            alert('请阅读并同意协议');
        }
    });
