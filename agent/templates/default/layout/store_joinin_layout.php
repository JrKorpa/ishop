...
<div class="header">
  ...
  <ul class="header_menu">
    <li class="<?php echo $output['show_sign']=='joinin' ? 'current':'';?>"><a href="<?php echo urlAgent('agent_register', 'show_join');?>" class="joinin"><i></i>代理商申请</a></li>
    <li class=""><a href="<?php echo urlAgent('agent', 'index');?>" class="login"><i></i>代理商管理中心</a></li>
  </ul>
</div>
