...
<style type="text/css">
body { _behavior: url(<?php echo AGENT_TEMPLATES_URL;?>/css/csshover.htc);
}
</style>
<link href="<?php echo AGENT_TEMPLATES_URL;?>/css/apply_base.css" rel="stylesheet" type="text/css">
<link href="<?php echo AGENT_TEMPLATES_URL;?>/css/home_header.css" rel="stylesheet" type="text/css">
<link href="<?php echo AGENT_TEMPLATES_URL;?>/css/home_login.css" rel="stylesheet" type="text/css">
