...
<!-- 							<div class="tip-arrow"></div> -->
	...
	<div class="bottom">
		<h6><?php echo $output['setting_config']['site_name']; ?> 版权所有</h6>
		<div class="copyright">
			<p><a href="http://www.kela.cn" target="_blank" class="copyright-logo"><?php echo $output['setting_config']['site_name']; ?>提供技术支持</a></p>
		</div>
	</div>
</div>
